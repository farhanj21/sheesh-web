      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12 max-w-4xl">
        ...
        >
          <h1 className="text-section font-bold text-4xl mb-4">
            <span className="text-silver-shine" data-text="Privacy Policy">Privacy Policy</span>
          </h1>
          <p className="text-xl max-w-2xl mx-auto text-center">
            <span className="font-fancy text-gold-shine italic leading-relaxed" data-text="Last updated: December 31, 2025">
        ...
        >
          <section>
            <h2 className="text-2xl font-display font-bold text-silver-shine mb-4">Introduction</h2>
            <p className="text-silver-400 font-fancy leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-silver-shine mb-4">Information We Collect</h2>
            <p className="text-silver-400 font-fancy leading-relaxed mb-3">
              We may collect the following types of information:
            </p>
            <ul className="list-disc list-inside text-silver-400 font-fancy leading-relaxed space-y-2 ml-4">
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-silver-shine mb-4">How We Use Your Information</h2>
            <p className="text-silver-400 font-fancy leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-silver-shine mb-4">Data Security</h2>
            <p className="text-silver-400 font-fancy leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-silver-shine mb-4">Third-Party Services</h2>
            <p className="text-silver-400 font-fancy leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-silver-shine mb-4">Cookies</h2>
            <p className="text-silver-400 font-fancy leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-silver-shine mb-4">Your Rights</h2>
            <p className="text-silver-400 font-fancy leading-relaxed mb-3">
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-silver-shine mb-4">Changes to This Policy</h2>
            <p className="text-silver-400 font-fancy leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-display font-bold text-silver-shine mb-4">Contact Us</h2>
            <p className="text-silver-400 font-fancy leading-relaxed">
              If you have any questions about this Privacy Policy or our data practices, please contact us through our <a href="/contact" className="text-gold-shine hover:text-gold-400 transition-colors">Contact page</a>.
            </p>
          </section>
        </motion.div>
      </div>
