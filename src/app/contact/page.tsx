          ...
          {socialLinks.map((social, index) => {
            ...
            return (
              <Component
                ...
                className="group relative bg-white/95 dark:bg-black/95 backdrop-blur-md border-2 border-gray-300 dark:border-gray-700 rounded-2xl p-8 text-center overflow-hidden transition-all duration-500 hover:border-gray-400 dark:hover:border-gray-600 hover:shadow-glow-dark-lg shadow-glow-dark cursor-pointer"
              >
