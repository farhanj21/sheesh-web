      ...
      <div className="relative z-10 container mx-auto px-6 lg:px-12">
        ...
        >
          <h1 className="text-section font-bold text-4xl mb-4">
            <span className="text-white" data-text="Get in Touch">Get in Touch</span>
          </h1>
          <p className="text-xl max-w-2xl mx-auto text-center">
            <span className="text-gray-300 italic leading-relaxed" data-text="We'd love to hear from you. Reach out through your preferred channel.">
          ...
          {socialLinks.map((social, index) => {
            ...
            return (
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-2xl text-white mb-3 group-hover:text-gray-300 transition-colors duration-300">
                  {social.name}
                </h3>
                <p className="text-sm text-silver-400 italic group-hover:text-silver-300 transition-colors duration-300">
                  {social.description}
                </p>
              </div>
          ...
          <div className="bg-dark-900/60 backdrop-blur-sm border border-silver-700/20 rounded-2xl p-8 md:p-12">
            <div className="text-center mb-8">
              <h2 className="text-section font-bold text-3xl mb-2">
                <span className="text-white" data-text="Send us an Email">Send us an Email</span>
              </h2>
              <p className="text-lg">
                <span className="text-gray-300 italic leading-relaxed" data-text="Fill out the form below and we'll get back to you soon">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label htmlFor="name" className="block text-silver-300 mb-2">
                    Your Name
                  </label>
                  <input
                    type="text"
                    ...
                    required
                    className="w-full px-4 py-3 bg-dark-800/50 border-2 border-silver-700/30 rounded-lg text-silver-100 placeholder-silver-500 focus:outline-none focus:border-silver-400 focus:bg-dark-800/70 focus:shadow-[0_0_20px_rgba(192,192,192,0.2)] transition-all duration-300"
                    placeholder="Enter your name"
                  />
                </div>
                <div>
                  <label htmlFor="email" className="block text-silver-300 mb-2">
                    Email Address
                  </label>
                  <input
                    type="email"
              ...
              <div>
                <label htmlFor="subject" className="block text-silver-300 mb-2">
                  Subject
                </label>
                <input
                  type="text"
              ...
              <div>
                <label htmlFor="message" className="block text-silver-300 mb-2">
                  Message
                </label>
                <textarea
                  id="message"
                  ...
                  required
                  rows={6}
                  className="w-full px-4 py-3 bg-dark-800/50 border-2 border-silver-700/30 rounded-lg text-silver-100 placeholder-silver-500 focus:outline-none focus:border-silver-400 focus:bg-dark-800/70 focus:shadow-[0_0_20px_rgba(192,192,192,0.2)] transition-all duration-300 resize-none"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                className="w-full group inline-flex items-center justify-center gap-3 px-6 py-4 text-md tracking-wide text-black bg-gradient-to-br from-gray-300 via-gray-100 to-gray-300 hover:from-gray-400 hover:via-gray-200 hover:to-gray-400 shadow-lg hover:shadow-xl transition-all duration-300 rounded-full disabled:opacity-50 disabled:cursor-not-allowed"
              >
                ...
                <div className="text-center">
                  <div className="mb-6">
                    <h3 className="text-section font-bold text-3xl mb-4">
                      <span className="text-white" data-text="Scan to Follow Us">
                        Scan to Follow Us
                      </span>
                    </h3>
                  </div>
                  ...
                  <div className="text-center mb-4">
                    <p className="text-xl">
                      <span className="text-gray-300 italic" data-text="@sheeshupyourlife">
                        @sheeshupyourlife
                      </span>
                    </p>
                  </div>
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-pink-500 to-purple-600 hover:from-pink-600 hover:to-purple-700 text-white font-semibold rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                  >
