        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            <h1 className="text-section font-bold text-4xl mb-4">
              <span className="text-white" data-text="Our Collection">Our Collection</span>
            </h1>
            <p className="text-xl max-w-5xl mx-auto text-center">
              <span className="text-gray-300 italic leading-relaxed lg:whitespace-nowrap" data-text="Discover handcrafted reflective art pieces that transform any space into a captivating experience.">
