...
export const ReviewSection: React.FC<ReviewSectionProps> = ({
  ...
  return (
    <div className="py-12 border-t border-gray-300 dark:border-neutral-700">
      <h2 className="text-3xl font-bold text-black dark:text-white mb-8">Customer Reviews</h2>
      ...
      {stats.totalReviews > 0 && (
        <div className="grid md:grid-cols-2 gap-8 mb-10">
          {/* Average Rating */}
          <div className="bg-gray-50 dark:bg-neutral-900 rounded-xl p-6 border border-gray-300 dark:border-neutral-700">
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-neutral-400">Based on {stats.totalReviews} review{stats.totalReviews !== 1 ? 's' : ''}</p>
            </div>
          </div>
            ...
            <div className="space-y-2">
              {[5, 4, 3, 2, 1].map((rating) => (
                <div key={rating} className="flex items-center gap-3">
                  <span className="text-sm text-gray-700 dark:text-neutral-300 w-8">{rating} ★</span>
                  ...
                  <span className="text-sm text-gray-600 dark:text-neutral-400 w-10 text-right">
      ...
      {isLoading && reviews.length === 0 ? (
        <div className="text-center py-12">
          <div className="animate-spin w-8 h-8 border-4 border-gray-300 dark:border-neutral-600 border-t-gray-900 dark:border-t-white rounded-full mx-auto"></div>
          <p className="text-gray-600 dark:text-neutral-400 mt-4">Loading reviews...</p>
        </div>
      ) : (
        <ReviewList
          reviews={reviews}
